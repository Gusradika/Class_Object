...
public class minuman extends sistemToko implements toko {

    // static Vector<String> barang2 = new Vector<String>();
    // static Vector<Integer> harga2 = new Vector<Integer>();
    // static Vector<Integer> stok2 = new Vector<Integer>();
